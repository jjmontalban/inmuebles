...
function inmuebles_mostrar_campos_personalizados( $post ) {
    ...
    $cert_energ = get_post_meta($post->ID, 'cert_energ', true);
    ...
    $orientacion = get_post_meta($post->ID, 'orientacion', false);
    ...
    <table class="form-table">
        ...
        <tr id="campo_tipologia_chalet">
            ...
            <td>
                <label><input type="radio" name="tipologia_chalet" value="atico">Adosado</label>
                <label><input type="radio" name="tipologia_chalet" value="estudio">Pareado</label>
                <label><input type="radio" name="tipologia_chalet" value="duplex">Independiente</label>
            </td>
        </tr>
        <tr id="campo_tipo_rustica">
            <th>Tipo de Casa Rústica*</th>
            <td>
                <label><input type="radio" name="tipo_rustica" value="finca">Finca</label>
                <label><input type="radio" name="tipo_rustica" value="castillo">Castillo</label>
                <label><input type="radio" name="tipo_rustica" value="casa_rural">Casa Rural</label>
                <label><input type="radio" name="tipo_rustica" value="casa_pueblo">Casa de Pueblo</label>
                <label><input type="radio" name="tipo_rustica" value="cortijo">Cortijo</label>
            </td>
        </tr>
        <tr id="campo_tipo_local">
            <th>Tipo de local</th>
            <td>
                <label><input type="radio" name="tipo_local" value="local" required>Local</label>
                <label><input type="radio" name="tipo_local" value="nave">Nave</label>
            </td>
        </tr>
        <tr id="campo_tipo_plaza">
            <th><label for="tipo_plaza">Tipo de plaza</label></th>
            <td>
                <select name="campo_tipo_plaza" id="tipo_plaza">
                    <option value="">Seleccionar</option>
        ...
        <tr>
            ...
            <td>
                <label><input type="radio" name="tipo_operacion" value="venta" required> Venta</label>
        ...
        <tr id="campo_caracteristica_piso">
            <th>Característica adicional</th>
            <td>
                <label><input type="checkbox" name="caracteristica_piso[]" value="atico">Ático</label>
                <label><input type="checkbox" name="caracteristica_piso[]" value="estudio">Estudio</label>
                <label><input type="checkbox" name="caracteristica_piso[]" value="duplex">Dúplex</label>
            </td>
        </tr>

        <tr id="campo_m_construidos">
            <th><label for="m_construidos">Metros Construidos*</label></th>
            <td><input type="number" name="m_construidos" id="m_construidos" value="<?php echo esc_attr($m_construidos); ?>"></td>
        </tr>
        <tr id="campo_m_utiles">
            <th><label for="m_utiles">Metros Útiles*</label></th>
            <td><input type="number" name="m_utiles" id="m_utiles" value="<?php echo esc_attr($m_utiles); ?>"></td>
        </tr>
        <tr id="campo_m_parcela">
            <th><label for="m_parcela">Metros de Parcela*</label></th>
            <td><input type="number" name="m_parcela" id="m_parcela" value="<?php echo esc_attr($m_utiles); ?>"></td>
        </tr>
        ...
        <tr id="campo_m_plaza">
            ...
            <td><input type="number" name="m_plaza" id="m_plaza"></td>
        </tr>
        ...
        <tr id="campo_num_ascensores">
            ...
            <td><input type="number" name="num_ascensores" id="num_ascensores" required></td>
        </tr>
        <tr id="campo_num_plazas">
            <th><label for="num_plazas">Número de plazas de garaje*</label></th>
            <td><input type="number" name="num_plazas" id="num_plazas" required></td>
        </tr>
        <tr id="campo_distribucion">
            <th><label for="distribucion">Distribución*</label></th>
            <td><input type="number" name="distribucion" id="distribucion" required></td>
        </tr>
        <tr id="campo_cert_energ">
            <th><label for="cert_energ">Certificación Energética*</label></th>
            <td>
                <select name="cert_energ" id="cert_energ">
                    <option value="">Seleccionar</option>
                    <option value="a" <?php selected($cert_energ, 'a'); ?>>A</option>
                    <option value="b" <?php selected($cert_energ, 'b'); ?>>B</option>
                    <option value="c" <?php selected($cert_energ, 'c'); ?>>C</option>
                    <option value="d" <?php selected($cert_energ, 'd'); ?>>D</option>
                    <option value="e" <?php selected($cert_energ, 'e'); ?>>E</option>
                    <option value="f" <?php selected($cert_energ, 'f'); ?>>F</option>
                    <option value="g" <?php selected($cert_energ, 'g'); ?>>G</option>
                    <option value="exento" <?php selected($cert_energ, 'exento'); ?>>Exento</option>
                    <option value="tramite" <?php selected($cert_energ, 'tramite'); ?>>En Trámite</option>
                </select>
                
                <th><label for="consumo_energ">Consumo Energético*</label></th>
                <td><input type="number" name="consumo_energ" id="consumo_energ" value="<?php echo esc_attr($consumo_energ); ?>"></td>
            </td>
        </tr>
        <tr id="campo_cal_emis">
            <th><label for="cal_emis">Calificación de Emisiones</label></th>
            <td>
                <select name="cal_emis" id="cal_emis">
                    <option value="">Seleccionar</option>
        ...
        <tr id="campo_estado_cons">
            ...
            <td>
                <label><input type="radio" name="estado_cons" value="buen_estado" <?php checked($estado_conservacion, 'buen_estado'); ?>> Buen Estado</label>
                <label><input type="radio" name="estado_cons" value="a_reformar" <?php checked($estado_conservacion, 'a_reformar'); ?>> A Reformar</label>
            </td>
        </tr>
        ...
        <tr id="campo_ac">
            ...
            <td>
                <label><input type="radio" name="ac" value="no" required>No disponible</label>
                <label><input type="radio" name="ac" value="frio">Frío</label>
                <label><input type="radio" name="ac" value="frio_calor">Frío/calor</label>
                <label><input type="radio" name="ac" value="preinst">Preinstalación</label>
            </td>
        </tr>
        <tr id="campo_uso_exl">
            <th>Uso exclusivo*</th>
            <td>
                <label><input type="radio" name="uso_exl" value="si">Sí</label>
                <label><input type="radio" name="uso_exl" value="no">No</label>
            </td>
        </tr>
        ...
        <tr class="orientacion">
            <th>Orientacion</th>
                <td>
                    <label><input type="checkbox" name="orientacion[]" id="norte" value="<?php echo esc_attr($norte); ?>">Norte</label>
                    <label><input type="checkbox" name="orientacion[]" id="sur" value="<?php echo esc_attr($sur); ?>">Sur</label>
                    <label><input type="checkbox" name="orientacion[]" id="este" value="<?php echo esc_attr($este); ?>">Este</label>
                    <label><input type="checkbox" name="orientacion[]" id="oeste" value="<?php echo esc_attr($oeste); ?>">Oeste</label>
                </td>
        </tr>
        ...
        <tr class="campos_caracteristicas_local">
            ...
            <td>    
                ...
                <label><input type="checkbox" name="cocina_equipada" id="cocina_equipada" value="<?php echo esc_attr($cocina_equipada); ?>">Cocina totalmente equipada</label>
        ...
        <tr class="caracteristicas_garaje">
            ...
            <td>    
                ...
                <label><input type="checkbox" name="alarma_cerarada" id="alarma_cerarada" value="<?php echo esc_attr($alarma_cerarada); ?>">Alarma con circuito cerrado</label>
